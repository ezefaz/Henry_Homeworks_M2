...
// Tu código acá:
var spanName = document.querySelector('#createdBy');
spanName.innerHTML = spanName.innerHTML + ' ' + 'Ezequiel';
...
todos.forEach(i =>  {
  toDoContainer.appendChield(todos[i])) });
*/
